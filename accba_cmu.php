			...
			$("#send-email").click(function() {
				...
				if (confirm('Are you sure you want to send all email?')) {
				    ...
				    jQuery.each(importExcelData, function(i, val) {
				    	//alert(JSON.stringify(importExcelData[i]));
				    	$.ajax({
						    url: "accba_cmu_mail.php",
						    type: "post",
						    data: {
							    Fullname: importExcelData[i]['Fullname'],
							    Email_Address: importExcelData[i]['Email Address'],
							    Link: importExcelData[i]['Link']
					    	},
