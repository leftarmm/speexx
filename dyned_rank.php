	...
	<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
						...
						<div class="m-portlet m-portlet--mobile">
							...
							<div class="m-portlet__body">
									<div class="form-group m-form__group row">
										...
										<div class="col-10">
											<input type="text" class="form-control" id="admin-email" value="siriluckt@dynatix.co.th">
										</div>
									</div>
									<div class="form-group m-form__group row">
										<label class="col-2 col-form-label">
										...
										<div class="col-10">
											<input type="text" class="form-control" id="admin-password" value="Koitao234">
										</div>
									</div>
								</form>
								<!--end: Search Form -->
		...
		<script type="text/javascript">
			...
			$("#send-email").click(function() {
				...
				if (confirm('Are you sure you want to send all email?')) {
				    ...
				    jQuery.each(importExcelData, function(i, val) {
				    	$.ajax({
						    url: "rank_user_dyned.php",
						    type: "post",
						    data: {
								admin_email: $('#admin-email').val(),
								admin_password: $('#admin-password').val(),
							    Test_Date: importExcelData[i]['Test_Date'],
							    STD_ID: importExcelData[i]['STD_ID'],
							    Student_Name: importExcelData[i]['Student Name'],
							    email: importExcelData[i]['email'],
							    PTL: importExcelData[i]['PTL'],
							    Current_Level: importExcelData[i]['Current Level'],
							    CEFR_Goal: importExcelData[i]['CEFR Goal']
					    	},
			...
			function BindTable(jsondata, tableid) {
			    ...
			    if(Object.keys(jsondata[0]).length != 7){
