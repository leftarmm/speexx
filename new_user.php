							...
							<div class="m-portlet__body">
								<form id="detail">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-10">
											<input type="text" class="form-control" id="admin-email" value="speexx@lanna.co.th">
										</div>
									</div>
									<div class="form-group m-form__group row">
										<label class="col-2 col-form-label">
										...
										<div class="col-10">
											<input type="text" class="form-control" id="admin-password" value="LannaCom@1">
										</div>
									</div>
								</form>
								<!--end: Search Form -->
